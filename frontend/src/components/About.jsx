      ...
      <div className="wrap py-20 sm:py-24">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[260px_1fr]">
              ...
              {about.tabs.map((t, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`flex shrink-0 items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-medium transition lg:shrink ${
                      on
          ...
          <Reveal key={active}>
            <div
              role="tabpanel"
              className="rounded-2xl border border-black/5 bg-mist p-8 sm:p-10"
            >
              ...
              <div className="mt-8 grid gap-4 border-t border-black/5 pt-8 sm:grid-cols-3">
                {about.strengths.map((s) => (
                  <div key={s.title}>
                    ...
                    <p className="mt-1.5 text-sm leading-snug text-slatey">{s.body}</p>
                  </div>
                ))}
              </div>
            </div>
